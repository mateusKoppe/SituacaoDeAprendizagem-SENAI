<div class="buttons-group buttons-group--vertical">
	...
	<a href="admin/cursos" class="button button--light">Cursos</a>
	<a href="admin/noticias" class="button button--light">Noticías</a>
	<a href="admin/contato" class="button button--light">Contatos</a>
